package com.vladeks.part_second_task_fird;
...
public class ReadWriteLock  {
    ...
    private final ReadWriteLock.ReadLock readerLock;

    /* Inner class providing writelock */
    private final ReadWriteLock.WriteLock writerLock;

    public ReadWriteLock.WriteLock writeLock() {
        return writerLock;
    }

    public ReadWriteLock.ReadLock readLock()  {
        return readerLock;
    }
